	...
	const projectArray = [
		{
			...
			highlightOne:
				'Hosts projects as well as Work History and Recommendations',
			stack:
				'React, React-Router-Dom, GSap & FontAwesome',
			status:
				' On-Going, As-Needed'
		},
		{
			...
			alt: 'project',
			to:
				'https://matt-wellman-imbd.netlify.com/',
			details:
			...
			stack:
				'React, React-Router-Dom, GSap & Font Awesome',
			status: ': Completed'
		},
		{
			id: 3,
			title:
				'TouchBase Social Network',
			src: `${TBProject}`,
			alt: 'project',
			to:
				'https://touch-base-29dce.firebaseapp.com/',
			body:
