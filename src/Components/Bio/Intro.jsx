			...
			<div className='bio-subtitle'>
				...
				<p className='weakness'>
					<q>
						...
						scale projects, beyond simple demos to further increase my proficiency
						in React as well as other modern JS frameworks.
					</q>
				</p>
				<p className='weakness'>
					<q>
						I am Ecma Script 6 & 7 efficient on the Javascript side of things.
						I use current practices in React (and React-Native) such as
