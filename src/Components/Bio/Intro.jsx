		...
		<div>
			<div className='bio-subtitle'>
				...
				<div className='weakness'>
					I began truly developing with libraries and frameworks the beginning of 2018, although I was language proficient in JavaScript well beforehand--as I wrote a lot of scripts to add functionality to spreadsheets in past. I have worked on numerous projects this year and I plan on
				...
				<div className='weakness'>
					I am good at parsing API docs and am familiar with react-helmet, Gsap animations, react-router-dom, uuid, react-calender to name a few, point being I can utilize any third-party api that has documentation.
					<br />
				</div>
			</div>
		</div>
