...
const Resume = () => {
  ...
  const openHardResume = () => {
    window.open(
      "https://drive.google.com/file/d/1eK2vuzQTNN4ZCmWqjts4ieJAy8FY4HCa/view?usp=sharing"
    );
  };
  ...
  return (
    <div className="parent">
      ...
      <ResumeCard
        ...
        highlight1={
          "A cool Badge of Honor I get to wear is that I am currently the only full stack developer at Techstyle Fashion Group."
        }
        highlight2={
          "Neat Fact: In order to get this position I Learned DynamoDb, Graphql, Apollo Server, Typescript and Urql and built the Fitness App in their app stack before the interview. Its on the example page of this site."
        }
        safe={moreAboutFIT}
        textWhenMore={
        ...
        resp1={"A lot of Tech Planning & Development"}
        resp2={
      ...
      <ResumeCard
        ...
        p2={
          "I loved the freedom of this work environment but felt that in order to develop in a less manic, learn-as-I-go approach, I needed to take a step back to constitute a solid learning period for myself."
        }
